                ...
                <div class="col-lg-6">
                    ...
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                            ...
                            <form method="post" action="<?php echo base_url()?>Res_Admin_menu/insert_menu_attr" >
...
<script>
    ...
    function selectid(x) {
        ...
        $.ajax({
            type:'POST',
            url:'<?php echo base_url("Res_Admin_menu/getres_id/")?>'+btn,
            data:{'rname':btn},
            cache: false,
            success:function(data)
            {
        ...
        $.ajax({
            type:'POST',
            url:'<?php echo base_url("Res_Admin_menu/getres_idformenu/")?>'+btn,
            data:{'rname':btn},
            cache: false,
            success:function(data)
            {
    ...
    function selectid4(x) {
        ...
        $.ajax({
            type:'POST',
            url:'<?php echo base_url("Res_Admin_menu/getres_id/")?>'+btn1,
            data:{'rname':btn1},
            cache: false,
            success:function(data)
            {
